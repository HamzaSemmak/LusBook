    ...
    <main class="Cgv">
        <div class="container Soufiane">
            ...
            <div>
                ...
                <div class="text">
                    Les présentes conditions générales de vente (C.G.V.) ont pour objet d'informer tout éventuel client sur les conditions ainsi que les modalités dans lesquelles le vendeur procède à la vente des produits du catalogue mise en ligne sur le site internet LUS-Book.COM.  Les C.G.V. fixent les droits et les obligations des parties dans le cadre de la vente. <br>
                    La validation de la commande par le client implique l’acceptation par l’acheteur de ces conditions générales de vente sans réserve. <br>
                ...
                <div class="text">
                    Toute commande en ligne implique l’acceptation des présentes conditions.
                </div>

                <div class="title"> Prix </div>
                <div class="text">
                    Les prix et taux de TVA sont ceux en vigueur au jour de la commande. <br>
                    ...
                    Néanmoins le client a le droit de refuser la correction du prix il sera libre d'annuler la commande corrigée et cela sans pénalités.
                </div>
                ...
                <div class="text">
                    Certains articles ne sont pas concernés par la livraison gratuite. <br>
                -   Livraison Maroc : Colissimo Suivi (assurance standard 230DHS par kilo) ou DPD. <br>
                -   Livraison Afrique : Colissimo Suivi Europe (assurance standard 230DHS par kilo) ou DHL. <br>
                -   Livraison Hors Afrique : Colissimo Suivi International (assurance standard 230DHS par kilo) ou DHL. <br>
                    &nbsp; &nbsp; LUS-Book.COM s'engage a mettre à la disposition du transporteur les produits commandés dans un délai maximum de 72h.
                </div>
            </div>
        </div>
    </main>
